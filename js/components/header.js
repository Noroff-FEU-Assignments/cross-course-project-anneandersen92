...
function createHeader() {
    header.innerHTML = header.innerHTML = `
        <div class="header-wrapper">
            ...
            <div class="icons">
            <a href="login.html"><span class="material-icons-outlined" title="User account" aria-label="user account icon">person</span></a>
            <span class="screenreader-text">User account</span>
            <a href="cart.html"><span class="material-icons-outlined" title="Shopping cart" aria-label="shopping cart icon">shopping_cart</span></a>
            ...
            <input type="checkbox" id="hamburger" /><nav class="hamnav">
                <div class="hamitems">
